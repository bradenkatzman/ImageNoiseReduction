...
/* this function takes a source image and an initialized result image and filters
 * the source for noise, removes the noisy pixels, and saves to the result image 
 */
...
int main(int argc, char** argv) {
  ...
  cout << "100% - rendering complete" << endl;;
